...
For larger boards, we propose bitboard representation with precomputed masks for Knights/Kings, and magic bitboards (or lookup) for sliding pieces. Even in Scala, a JNI or Panama wrapper around a thin C routine for attacks could provide a 30-50% improvement without changing the algorithm.
